...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (user) return interaction.reply("You've already started your Pokémon journey!");
        ...
        // paginationEmbed(interaction, pages, buttonList, timeout);  @DISCORD-BUTTONS
        // There you go, now you have paged embeds

        interaction.reply({ embeds: [pages[current_page_number]] , components: [buttons]})
